...
**Actividades**
 ...
 - Realizar una tabla ** (sprint backlog)** que contenga las actividades a realizar durante el sprint, responsables, el estado de la tarea (finalizada, en proceso), fecha de inicio, fechas límite de entrega y nivel (bajo, medio, alto).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxNzYwNTQ0NiwtNTQwMjQyODczLC0yMD
