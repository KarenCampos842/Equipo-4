...
**Actividades**
 ...
 - **Artefactos**:  Artefactos que especifican los requisitos, incluye excepciones a considerar (*casos de uso, historias de usuario con criterios de aceptación). Realizar  un diagrama de casos de uso que resuma el conjunto de requisitos (funcionales, no funcionales). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mzk4NzU2NjUsNjMwNjY0MTc5LDE1ND
