...
<table align=center>  
   ...
   <tr>  
      <th>Descripción de errores</th>
       <td colspan=5> Intento iniciar sesión sin antes haberse registrado (tarea 1). <br> Ingresó al menú de las tres rayas </td> 
   </tr>  
    <tr>  
      <th>Comentarios/Observaciones</th>
       <td colspan=5>Se le facilitó al cliente porque está acostumbrada a la tecnología y a éste tipo de interfaces.</td> 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc4MTIwMjI2LC05MDc1NTQ1MjZdfQ==
-->