...
<table align=center>  
   <tr>  
     ...
     <tr>  
      <td>Máximo de 1 error por tarea.</td>
      <td rowspan=3>
    RNF-27. El sistema debe ser intuitivo, gráfico y agradable para la mayoría de usuarios.
      </td>    
     </tr>
      <tr>  
      <td>Tareas 1-8 completadas en el tiempo esperado</td>
     </tr>
      <tr>  
      <td>Promedio Del 1 al 5, siendo 1 muy difícil y 5 muy fácil, ¿Qué calificación le otorga a ésta tarea?</td>
     </tr>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4NTc2OTU4Nyw2MzUyNDEwMzcsLTE0NT
