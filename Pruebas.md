...
<table align=center>  
   <tr>  
    ...
    <tr>  
      <td colspan=4>Rubéen Moisées Loria Pech</td>  
   ...
   <tr>  
    ...
    <tr>  
      <th>Comentarios/Observaciones</th>
       <td colspan=5>"Nnormalmente los adultos se guíian máas por las primeras 3 letras, no terminanr de leer las cosas y no se molestan en intentarlo, creo que lo mejor es poner dibujitos para mas intuitivo". </td> 
   </tr>
 </table>
 <br>
 <br>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUyNDk5NzhdfQ==
-->