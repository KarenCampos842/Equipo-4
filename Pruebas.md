...
<table align=center>  
   ...
   <tr>  
      <th>Descripción de errores</th>
       <td colspan=5> Intento iniciar sesión sin antes haberse registrado (tarea 1). <br> Abrio el menú de búsqueda (tarea 3). <br> Le picó a la imagen de perfil de usuario en  </td> 
   </tr>  
    <tr>  
      <th>Comentarios/Observaciones</th>
       <td colspan=5>Se le facilitó al cliente porque está acostumbrada a la tecnología y a éste tipo de interfaces.</td> 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMTQ0MTU4MCwtOTA3NTU0NTI2XX0=
-->